...
_HOME_MAP_MARKERS = [
    ...
    ("恒生指数", "HK", 22.2847, 114.1583, -46, 6),      # 港交所 中环交易广场
    ("上证指数", "A", 31.2222, 121.5083, 6, 0),          # 上交所 浦东南路528号
    ("标普500", "US", 40.7069, -74.0113, 0, 0),          # 纽交所 华尔街11号
    ("纳斯达克100", "US", 40.7069, -74.0113, 0, 40),     # 纳斯达克也在曼哈顿，共用圆点
    ("日经225", "GLOBAL", 35.6837, 139.7788, 18, 0),     # 东交所 日本桥兜町
    ("富时100", "GLOBAL", 51.5155, -0.0983, -46, 0),     # 伦交所 Paternoster Square
    ("德国DAX", "GLOBAL", 50.1155, 8.6796, 42, 16),      # 法兰克福交易所 Börsenplatz
