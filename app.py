...
_HOME_MAP_MARKERS = [
    ...
    #   dy=-23 → 标签不再挂在圆点下方，而是**平移到圆点左边、垂直居中**
    #            （y[165,203] 对齐圆点 180），右沿离香港圆点只有10像素，
    #            离上证标签还有7像素缝，离新加坡圆点38像素。
    # 负的 dy 表示往上抬——挂在下面这条规则对其它十个都成立，唯独这里放不下。
    ("恒生指数", "HK", 22.2847, 114.1583, -44, -23),    # 港交所 中环交易广场
