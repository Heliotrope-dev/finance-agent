...
8. 除了四选一的结论，还要给一个0-100的综合得分，用来跨市场、跨股票统一
   ...
   - 技术面与进场时点（0-20分）：短线定位下这一项从"辅助确认"升为主线之一——
     5-10天的持有窗口里，进场时点几乎就是全部——这么短的时间里基本面几乎不动，赚的就是进出场价差。看均线排列、MACD动能是否
...
10. 投资期限（必填），分两档给。**这位用户做的是短线甚至超短线**，
   2026-09-06 明确要求把周期从"一到四周"缩短到"5-10天，甚至加上1-2天的
   ...
   短线（5-10天）：这一到两周有没有一段可以吃的行情？看的是趋势是否
